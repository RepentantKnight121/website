...
function AddCoffeeCategory() {
  ...
  const EditCoffeeCategory = async (id, name) => {
    try {
      const jsonData = {
        "coffee_category_id": `${id}`,
        "coffee_category_name": `${name}`
      }
      const deleteCoffeeCategory = await fetch("http://localhost:5678/api/coffee-category/change", {
        method: "PUT",
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  ...
                  <button
                    ...
                    onClick={() => setEditCoffeeCategory(false)}
                  >
