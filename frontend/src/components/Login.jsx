    ...
    function Login() {
      ...
      <div class="mx-2 my-20 grid place-items-center sm:my-auto">
        ...
        <div class="w-11/12 rounded-lg bg-white p-12 px-6 py-10 shadow-md sm:w-8/12 sm:px-10 sm:py-6 md:w-6/12 lg:w-5/12 lg:shadow-lg 2xl:w-4/12">
          ...
          <h2 class="text-center text-3xl font-semibold text-gray-800 lg:text-4xl">Login</h2>
          ...
          <form class="mt-10" method="POST">
            ...
            <button type="submit" class="mt-10 w-full rounded-sm bg-gray-800 py-3 font-medium uppercase text-white hover:bg-gray-700 hover:shadow-none focus:outline-none">Login</button>
